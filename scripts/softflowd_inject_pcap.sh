...
$CPE_EXEC /usr/local/sbin/softflowd -d -r /usr/local/etc/softflowd/capture+crypto+type2+8+vlan.pcap -v 9 -t maxlife=30s -T ether -n goflow2.default.svc.cluster.local:9995 &
sleep 10
